...
We analyze here the error for the argument reduction
$\frac{x}{1+\sqrt{1+x^2}}$.
...
\end{quote}
Using Higham's method, we denote $\theta_i$ variables such that 
$|\theta_i| \leq 2^{-p}$, where $p$ is the working precision.
We have $s = y^2 (1 + \delta)^2 (1 + \theta_1)$,
$t = [1 + y^2 (1 + \delta)^2 (1 + \theta_1)] (1+\theta_2) 
   = (1+y^2) (1 + \delta)^2 (1+\theta_3)^2$,
$u = \sqrt{1+y^2} (1 + \delta) (1+\theta_3) (1+\theta_4) 
   = \sqrt{1+y^2} (1 + \delta) (1+\theta_5)^2$,
$v = [1 + \sqrt{1+y^2} (1 + \delta) (1+\theta_5)^2] (1+\theta_6)
   = (1 + \sqrt{1+y^2}) (1 + \delta) (1+\theta_7)^3$,
\[ w = \frac{y (1 + \delta)}{(1 + \sqrt{1+y^2}) (1 + \delta) (1+\theta_7)^3}
       (1+\theta_8)
     = \frac{y}{1 + \sqrt{1+y^2}} (1+\theta_9)^4. \]
